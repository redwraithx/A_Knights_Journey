...
public class BanditGuard_Health : MonoBehaviour
{
    public BanditGuard_Vision enemyVisionScript = null;
    ...
    private void Update()
    {
        if (currentHealth <= 0)
        {
            if (!isDead)
            {
                ...
                GetComponent<BanditGuard_Vision>().activeEnemyState = CurrentState.Dead;
