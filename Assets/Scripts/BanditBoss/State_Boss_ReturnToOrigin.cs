...
public class State_Boss_ReturnToOrigin : StateMachineBehaviour
{
    public BanditBoss_Vision enemyVisionScript;
    public BanditBoss_Movement enemyMovementScript;
    ...
    override public void OnStateEnter(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        enemyMovementScript = animator.GetComponent<BanditBoss_Movement>();
